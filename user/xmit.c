...
xfputc(int (*output_cb)(void *, char), void *param, char c) {
  return output_cb(param, c);
}

int ICACHE_FLASH_ATTR
xfputs(int (*output_cb)(void *, char), void *param, const char *str) {
  int ret = 0, iret;
  while (*str) {
...
int ICACHE_FLASH_ATTR xvfprintf(int (*output_cb)(void *, char), void *param,
...
*/
int ICACHE_FLASH_ATTR
xfprintf(int (*output_cb)(void *, char), void *param, const char *fmt, ...) {
  int ret;
  va_list args;
  va_start(args, fmt);
